...
is also \emph{reader-scale robust}: repeating with a stronger \texttt{Qwen2.5-3B} reader (three
seeds) the gap persists and if anything grows, to $0.058\pm0.005$ F1 at $B=128$ and $0.036\pm0.018$
at $B=256$, with the interior optimum at $\dr{=}80$ in all three seeds. This is the signature of an
\emph{information} bottleneck rather than a reasoning one---a more capable reader extracts more from
good context, so the penalty for the evidence the two stages discard is more visible, not less,
unlike a context-cleanup heuristic whose benefit a strong reader absorbs. It is also
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/e9_real_qa.pdf}
...
E9c & real & HotpotQA; Qwen2.5-\textbf{3B}; 3 seeds & reader-robust: gap $0.058{\pm}0.005$ at $B{=}128$ (grows vs 1.5B)\\
