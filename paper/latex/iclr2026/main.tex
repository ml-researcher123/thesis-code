...
context-cleanup heuristic whose benefit a stronger reader absorbs. It is also dataset- and
task-general (three seeds each): the tight-budget gap is $0.048\pm0.014$ F1 on a second multi-hop
benchmark (2WikiMultihopQA) and a comparable $0.055\pm0.025$ on a \emph{single-hop} task (SQuAD),
both with the same interior optimum---so it is not an artifact of multi-hop composition.

\begin{figure}[t]
\centering
\includegraphics[width=0.82\linewidth]{figures/e9_real_qa.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.42\linewidth]{figures/c4_facetlens_escape.png}
\hfill
\includegraphics[width=0.42\linewidth]{figures/c4b_real_facetlens.png}
...
E10 & real & \textbf{SQuAD} (single-hop); Qwen2.5-1.5B; 3 seeds & task-general: gap $0.055{\pm}0.025$ at $B{=}128$; interior optimum; not a multi-hop artifact\\
