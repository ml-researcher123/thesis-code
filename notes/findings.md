...
| F8 | Misaligned (anti-correlated-hardness) bottlenecks compound **super-multiplicatively**: pipeline recall < recall_R · recall_C. | HYPOTHESIS | E3b (building next). This is the non-obvious core of C2. |
