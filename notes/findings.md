...
| F9 | The free-vector walls (E1/E2) and compounding (E3) persist with **real trained models**. | HYPOTHESIS | E4+ real-model experiments (next). Without this the theory is a toy. |
