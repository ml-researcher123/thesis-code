...
| F9 | The free-vector walls (E1/E2) and compounding (E3) persist with **real trained models**. | SUPPORTED (retrieval side) | E4 (`outputs/e4_real_retrieval_wall`): mxbai-embed-large on SciFact ramps then plateaus; d=512 and d=1024 give identical recall@10=0.872 → top half of dims wasted. Compression side = E5 (next). |
